...
else
{
	...
	else
	{
		global $wp_version ;
		?>
		<form id="ux_frm_bkup_system_status" class="layout-form bkup_page_width" method="post">
			<div class="fluid-layout">
				<div class="layout-span12 responsive">
					<div class="widget-layout">
						<div class="widget-layout-title">
							<h4>
								<?php _e("Wp Backup Bank System Status", wp_backup_bank); ?>
							</h4>
						</div>
						<div class="widget-layout-body">
							...
							<div class="fluid-layout">
								<div class="layout-span6 responsive">
									<div class="widget-layout">
										<div class="widget-layout-title">
											<h4><?php _e("Environment", wp_backup_bank); ?></h4>
										</div>
										<div class="widget-layout-body">
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Home URL", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo home_url(); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Site URL", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo site_url(); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Version", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php bloginfo("version"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Multisite Enabled", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php if (is_multisite()) _e("Yes", wp_backup_bank); else _e("No", wp_backup_bank); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Web Server Info", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo esc_html($_SERVER["SERVER_SOFTWARE"]); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Version", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php if (function_exists("phpversion")) echo esc_html(phpversion()); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("MySQL Version", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
													<?php 
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Debug Mode", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php if (defined("WP_DEBUG") && WP_DEBUG) _e("Yes", wp_backup_bank); else _e("No", wp_backup_bank); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Language", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php if (defined("WPLANG") && WPLANG) echo WPLANG; else _e("Default"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Post Max Size", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
													<?php 
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("WP Max Upload Size", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
										...
										<?php if (function_exists("ini_get")) : ?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Script Execute Time", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo ini_get("max_execution_time"); ?>s</span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Input Vars", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo ini_get("max_input_vars"); ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("SUHOSIN Installed", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo extension_loaded("suhosin") ? _e("Yes", wp_backup_bank) : _e("No", wp_backup_bank); ?></span>
												</div>
											</div>
										<?php endif; ?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Default Timezone", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php
										...
										?>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Operating System", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Memory usage", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("SQL Mode", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php echo $sqlmode; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Safe Mode", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Allow URL fopen", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Memory Limit", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Max Post Size", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PCRE Backtracking Limit", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP Exif support", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php echo $exif; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP IPTC support", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php echo $iptc; ?>
													</span>
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("PHP XML support", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php echo $xml; ?>
													</span>
								...
								<div class="layout-span6 responsive">
									<div class="widget-layout">
										<div class="widget-layout-title">
											<h4><?php _e("Plugins", wp_backup_bank); ?></h4>
										</div>
										<div class="widget-layout-body">
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Installed Plugins", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span>
														<?php
														...
														foreach ($active_plugins as $plugin) {
															...
															if (!empty($plugin_data["Name"])) {
																...
																if (strstr($dirname, wp_backup_bank)) {
									...
									<div class="widget-layout">
										<div class="widget-layout-title">
											<h4><?php _e("Themes", wp_backup_bank); ?></h4>
										</div>
										<div class="widget-layout-body">
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Theme Name", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
													<span><?php echo $active_theme->Name; ?></span>
												</div>
											</div>
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Theme Version", wp_backup_bank); ?> :</label>
													<div class="layout-controls bkup-custom-layout-control">
													<span><?php
											...
											<div class="layout-control-group">
												<label class="layout-control-label"><?php _e("Author URL", wp_backup_bank); ?> :</label>
												<div class="layout-controls bkup-custom-layout-control">
		...
		<script type="text/javascript">
			...
			jQuery("a.system-report").click(function () {
				...
				try {
					jQuery("#bkup-system-report").slideDown();
					jQuery("#bkup-system-report textarea").val(report).focus().select();
					jQuery(this).fadeOut();
			...
			jQuery("a.close-report").click(function () {
				jQuery("#bkup-system-report").slideUp();
				jQuery(this).fadeOut();
